    ...
    final class LocalityFinderTests: XCTestCase {
        ...
        func testEqual() {
            let locality = LFFinder().localitiesDictionary["河南省"]!["郑州市"]!["上街区"]!
            print(locality)
            XCTAssertEqual(locality.code, 410106)
        }
        
        func testProvince() {
            let provinces = LFFinder().localitiesDictionary.orderedKeys
            print(provinces)
        ...
        func testCities() {
            let cities = LFFinder().localitiesDictionary["河南省"]!.orderedKeys
            print(cities)
        ...
        func testDistricts() {
            let districts = LFFinder().localitiesDictionary["河南省"]!["郑州市"]!.orderedKeys
            print(districts)
        ...
        func testAbbriable() {
            //let locality1 = LFFinder().localitiesDictionary["河南省"]!["郑州市"]!["上街区"]!
            //let locality2 = LFFinder().localitiesDictionary["河南省", "郑州市", "上街区"]
